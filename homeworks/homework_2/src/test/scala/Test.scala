...
object Test extends TestSuite {
        val testCase1: Map[String, (Int, Double)] =
            Map("Aluminum" -> (3, 2.6889))
        val testCase2: Map[String, (Int, Double)] =
            Map("Tungsten" -> (2, 0), "Graphite" -> (12, 2.1), "Aluminum" -> (0, 2.6889))
        val testCase3: Map[String, (Int, Double)] =
            Map(
                "Calcium" -> (8, 1.55), "Potassium" -> (14, 0.862), "Graphite" -> (12, 2.1), "Magnesium" -> (10, 1.738),
                "Lithium" -> (12, 0.534), "Tungsten" -> (2, 19.35), "Aluminum" -> (3, 2.6889), "Cobalt" -> (4, 8.90),
                "Gold" -> (2, 19.32), "Iron" -> (3, 7.874)
            )
        val testCase4: Map[String, (Int, Double)] =
            Map(
                "Cesium" -> (7, 1.873), "Tungsten" -> (2, 19.35), "Copper" -> (3, 8.96), "Iron" -> (3, 7.874),
                "Gold" -> (2, 19.32), "Potassium" -> (14, 0.862), "Calcium" -> (8, 1.55), "Cobalt" -> (4, 8.90),
                "Zirconium" -> (3, 6.45), "Magnesium" -> (10, 1.738), "Graphite" -> (12, 2.1), "Lead" -> (2, 11.336),
                "Nickel" -> (2, 8.91), "Tin" -> (1, 7.29), "Platinum" -> (1, 21.45), "Plutonium" -> (3, 19.25),
                "Sodium" -> (5, 0.971), "Titanium" -> (2, 10.50), "Silver" -> (4, 4.505), "Uranium" -> (2, 19.04),
                "Chrome" -> (3, 7.18), "Aluminum" -> (3, 2.6889), "Lithium" -> (12, 0.534)
            )
        ...
        val tests: Tests = Tests {
            ...
            'test_sumOfDivBy3Or5 - {
                ...
                assert(Exercises.sumOfDivBy3Or5(-10, 0) == -24)
                assert(Exercises.sumOfDivBy3Or5(0, 10) == 24)
            ...
            'test_primeFactor - {
                ...
                assert(Exercises.primeFactor(119) == Seq(7, 17))
            ...
            'test_sortByHeavyweight - {
                assert(Exercises.sortByHeavyweight(testCase1) == Seq("Aluminum"))
                assert(Exercises.sortByHeavyweight(testCase2) == Seq("Aluminum", "Tungsten", "Graphite"))
                assert(Exercises.sortByHeavyweight(testCase3) == Seq("Aluminum", "Iron", "Lithium", "Gold", "Tungsten", "Calcium", "Cobalt", "Potassium", "Magnesium", "Graphite"))
                assert(Exercises.sortByHeavyweight(testCase4) == Seq("Tin", "Platinum", "Aluminum", "Sodium", "Nickel", "Titanium", "Lead", "Zirconium", "Chrome", "Iron", "Silver", "Uranium", "Lithium", "Gold", "Tungsten", "Copper", "Cesium", "Calcium", "Cobalt", "Potassium", "Plutonium", "Magnesium", "Graphite"))
